			...
			<div class="gallery-card" style="--hover-color: <?php echo $hoverColors[$index % count($hoverColors)]; ?>;">
				...
				<div class="hover-info">
					<dl class="hover-info__list">
						<div class="hover-info__item"><dt>Titre</dt><dd><?php echo htmlspecialchars($p['title']); ?></dd></div>
						<div class="hover-info__item"><dt>Catégorie</dt><dd><?php echo htmlspecialchars($p['meta'] ?: 'À renseigner'); ?></dd></div>
						<div class="hover-info__item"><dt>Dimensions</dt><dd><?php echo htmlspecialchars($p['dimensions'] ?: 'À renseigner'); ?></dd></div>
						<div class="hover-info__item"><dt>Technique utilisée</dt><dd><?php echo htmlspecialchars($p['technique'] ?: 'À renseigner'); ?></dd></div>
					</dl>
				</div>
			</div>
			<?php endforeach; ?>
