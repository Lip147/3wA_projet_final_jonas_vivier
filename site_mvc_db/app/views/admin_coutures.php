...
<body>
    <div class="container">
        ...
        <form method="post" action="<?php echo rtrim(app_url(), '/'); ?>/admin/coutures/add" enctype="multipart/form-data">
            ...
            <input type="text" name="dimensions_or_size" placeholder="Dimensions (ex. : 80 x 60 cm)">
            <input type="text" name="material" placeholder="Technique utilisée">
        ...
        <div style="background:#f0f0f0;padding:1rem;margin-bottom:2rem;border-radius:4px;border-left:4px solid #222;">
            ...
            <form method="post" action="<?php echo rtrim(app_url(), '/'); ?>/admin/coutures/update" enctype="multipart/form-data">
                ...
                <input type="text" name="meta" placeholder="Catégorie" value="<?php echo htmlspecialchars($editCouture['meta']); ?>">
                <input type="text" name="dimensions_or_size" placeholder="Dimensions (ex. : 80 x 60 cm)" value="<?php echo htmlspecialchars($editCouture['dimensions_or_size'] ?? ''); ?>">
                <input type="text" name="material" placeholder="Technique utilisée" value="<?php echo htmlspecialchars($editCouture['material'] ?? ''); ?>">
